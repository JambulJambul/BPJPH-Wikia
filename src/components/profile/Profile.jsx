            ...
            <div className="mt-16">
              ...
              <div className="flex justify-between items-center my-5 px-6">
                ...
                <button
                  ...
                  className={`${activeTab === 'logout' ? 'bg-gray-100' : 'bg-transparent'
                    } text-gray-500 hover:text-gray-900 rounded transition duration-150 ease-in font-medium text-sm text-center w-full py-3`}
                >
                  LOGOUT
                </button>
              ...
              <div className="w-full">
                ...
                <div className="mt-5 w-full flex flex-col items-center overflow-hidden text-sm">
                  <Link to="/" className="w-full border-t border-gray-100  text-center text-gray-600 py-4 pl-6 pr-3 block hover:bg-gray-100 transition duration-150">
                    <FaUserCircle size={24} className="rounded-full h-6 shadow-md inline-block mr-4"/>
                  </Link>
                </div>
              </div>
            </div>
